...
class Window:
    ...
    def __init__(self, width, height) -> None:
        ...
        self.__canvas.pack(fill=BOTH, indent=1)
    ...
    def draw_line(self, line, fill_color="red") -> None:
